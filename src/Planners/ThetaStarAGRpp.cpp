...
namespace Planners
{
    ThetaStarAGRpp::ThetaStarAGRpp(const rclcpp::Node::SharedPtr& node) : ThetaStar("thetastaragrpp"), node_(node) {}
    ...
    void ThetaStarAGRpp::setParam()
    {
        ...
        node_->declare_parameter("thetastaragr.epsilon", 0.0);
        ...
        RCLCPP_INFO(node_->get_logger(), "thetastaragr.epsilon: %f", epsilon_);
