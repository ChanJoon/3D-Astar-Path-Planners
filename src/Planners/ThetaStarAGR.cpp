...
namespace Planners
{
                                    ...
                                    Eigen::Vector3d _target)
    {
        ...
        {
            start_node->g_score += flying_cost_ * start_node->position[2] / 2.0 + flying_cost_default_;
            start_node->f_score += flying_cost_ * start_node->position[2] / 2.0 + flying_cost_default_;
            start_node->penalty_g_score = flying_cost_ * start_node->position[2] / 2.0 + flying_cost_default_;
